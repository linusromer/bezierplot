...
The following graphs are drawn with \texttt{bezierplot} (black) and Gnuplot (red). Gnuplot calculated 1000 samples per example. The functions are given below the pictures (left: bezierplot, right: Gnuplot).
\begin{multicols}{3}
